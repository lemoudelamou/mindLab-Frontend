...
import {
    deleteExperimentDataById,
    deletePatientById,
    getExperimentsDataById,
    getPatientByFullnameAndId
} from "../../Api/Api";
import secureLocalStorage from "react-secure-storage";
import Spinner from "../../utils/Spinner";

const ModifyPatientResults = () => {
        ...
        const fetchData = async () => {
            try {
                if (patientId && fetchDataTrigger) {
                    const allData = await getPatientByFullnameAndId(fullname, patientId);
...
export default ModifyPatientResults;
