        ...
        <div className="instructions-container" >
            ...
            <div className="instructions-box">
                ...
                <ul>
                    ...
                    <li>When you see the color below, you have to click on the space bar. <HexToColorPreview hexColor={DemoHexColor}/></li>
                </ul>
...
export default DemoExperimentInstructionsBox;
